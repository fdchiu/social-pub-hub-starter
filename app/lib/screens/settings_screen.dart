...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final draftCount = ref.watch(allDraftsStreamProvider).valueOrNull?.length;
    final variantCount =
        ...
        children: [
          Card(
            child: ListTile(
              ...
              title: const Text('Project settings moved to Projects screen'),
              subtitle: const Text(
                'This Settings screen is app-wide. Manage project/post metadata in Projects.',
              ),
